   ...
   <div class="footer">
	     ...
	     <div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					<h4>Contact</h4>
						...
						<div class="social-icons">
							<h4>Follow Us</h4>
						<?php 
							$selectSocialLink = $lk->selectSocialLink();
							if($selectSocialLink){
								while($result = $selectSocialLink->fetch_assoc()){ ?>
					   		  ...
					   		  <ul>
							      ...
							      <li class="googleplus"><a href="<?php echo $result['googleplus']; ?>" target="_blank"> </a></li>
							      <li class="contact"><a href="<?php echo $result['linkedin']; ?>" target="_blank"> </a></li>
							      <div class="clear"></div>
						     </ul>
								<?php } } ?>
   	 					</div>
			...
			<?php 
				$selectCopyright = $lk->selectCopyright();
				if($selectCopyright){
					while($result = $selectCopyright->fetch_assoc()){ ?>
